...
<head>
    ...
    <link rel="apple-touch-icon" sizes="180x180" href="https://bengalurutechsummit.com/apple-touch-icon.png">
<link rel="icon" type="image/png" sizes="32x32" href="https://bengalurutechsummit.com/favicon-32x32.png">
<link rel="icon" type="image/png" sizes="16x16" href="https://bengalurutechsummit.com/favicon-16x16.png">
...
<script>
    ...
    if (document.getElementById('sectors-list')) {
        var element = document.getElementById('sectors-list');
        const example = new Choices(element, {
            searchEnabled: false
        });
    };
    if (document.getElementById('subSectors-list')) {
        var element = document.getElementById('subSectors-list');
        const example = new Choices(element, {
            searchEnabled: false
        });
    };
