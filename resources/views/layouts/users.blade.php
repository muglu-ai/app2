...
<head>
    ...
    <title>
        @yield('title', config('constants.APP_NAME') . ' Exhibitor Panel')
    </title>
    </title>
                    ...
                    <div class="copyright text-center text-sm text-muted text-lg-start">
                        <ul class="nav nav-footer">
                            <li class="nav-item d-flex justify-content-between w-100">
                                <span class="ms-2">© <script>document.write(new Date().getFullYear())</script> Copyright {{config('constants.EVENT_NAME')}}, All Rights Reserved</span>
