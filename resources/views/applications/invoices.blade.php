...
@section('title', 'Invoice(s)')
@section('content')
    <script src="https://cdn.jsdelivr.net/npm/sweetalert2@11"></script>
    <div class="container-fluid py-2">
        <div class="row">
            <div class="ms-3 mt-3">
    <h3 class="mb-0 h4 font-weight-bolder mb-3">Invoices and Documents</h3>
            </div>
        </div>
                        ...
                        <div class="table-responsive p-0">
                            <table class="table table-flush mb-0">
                                <thead class="thead-light table-dark">
                                    <tr>
                                        <th class="text-left  text-uppercase text-white text-md font-weight-bolder  ps-2">Date</th>
                                        <th class="text-left  text-uppercase text-white text-md font-weight-bolder ps-2">Invoice ID</th>
...
{{--                                            <td class="text-center">{{ $invoice->payment_status }}</td>--}}
                                            <td class="text-left text-dark text-md">
                                                <span class=" badge d-block w-50 bg-{{ $invoice->payment_status == 'paid' ? 'success' : 'danger' }}">
                    ...
                    <div class="card-body px-0 pt-0 pb-2">
                        <div class="table-responsive p-0">
                            <table class="table table-flush mb-0">
                                ...
                                <tr>
                                    <th class="text-left text-uppercase text-white text-md font-weight-bolder  ps-2">Date</th>
                                    <th class="text-left text-uppercase text-white text-md font-weight-bolder ps-2 ">Transaction No</th>
                                    <th class="text-left text-uppercase text-white text-md font-weight-bolder  ps-2">Total Amount Paid</th>
                                    <th class="text-left text-uppercase text-white text-md font-weight-bolder  ps-2">Verification Status</th>
                                </tr>
                                </thead>
                                <tbody>
                                @foreach($payments as $payment)
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-dark text-md"><span class=" badge d-block w-35 bg-{{ $payment->verification_status  == 'Verified' ? 'success' : 'danger'}}">{{ ucfirst($payment->verification_status) }}</span></td>
                                    </tr>
                                @endforeach
                                </tbody>
                            </table>
