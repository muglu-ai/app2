...
@section('content')
                    ...
                    <div class="row mb-4 align-items-center">
                        ...
                        <div class="col-md-6 text-md-end">
                            @if ($application->semi_member == 1)
                                <span class="badge {{ $application->membership_verified == 1 ? 'bg-success' : 'bg-warning' }}">
                                    Membership Verification: {{ $application->membership_verified == 1 ? 'Verified' : 'Pending' }}
                                </span>
                            @endif
                                                ...
                                                <div class="card h-100 shadow-sm">
                                                    ...
                                                    <div class="card-body d-flex flex-column">
                                                        ...
                                                        <div class="mt-auto">
                                                            ...
                                                            @php
                                                             if ($application->semi_member == 1 && $application->membership_verified == 1) {
                                                            ...
                                                            @else
                                                                ...
                                                                @else
                                                                    <button
                                                                        class="btn btn-primary w-100 mt-2 add-to-cart-btn text-white"
                        ...
                        <form id="apply-now-form" method="POST" action="{{ route('sponsor.store') }}">
                            ...
                            @if (isset($application) && $application->allocated_sqm > 72)
                                <p class="text-success">🎁 You're eligible for
                                    ...
                                    towards Title Sponsor added from the purchase of a {{$application->allocated_sqm}} SQM Exhibition Booth.
                                </p>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function () {
            // Find the first collapsible button
            const firstCategoryButton = document.querySelector('.btn-outline-primary[data-bs-target]');
            if (firstCategoryButton) {
                const targetId = firstCategoryButton.getAttribute('data-bs-target');
                // Automatically show the first category's collapse
                const firstCollapse = document.querySelector(targetId);
                if (firstCollapse) {
