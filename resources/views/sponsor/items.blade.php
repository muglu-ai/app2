                ...
                <div class="container">
                    <div class="mb-4">
                        ...
                        <p class="text-muted mt-2">
                            Showcase your brand at {{ config('constants.EVENT_NAME') }}
                        </p>
                    </div>
                    ...
                    <div class="card p-4">
                        <div class="d-flex align-items-center gap-3">
                            ...
                            <div>
                                ...
                                <p class="text-muted">
                                    We're finalizing our sponsorship packages. Please check back soon or visit our website <a href="{{config('constants.EVENT_WEBSITE')}}" target="_blank">{{ config('constants.EVENT_WEBSITE') }}</a> for more information.
                                </p>
                            </div>
                        </div>
                    </div>
                                ...
                                <form action="{{ route('sponsor.store') }}" method="POST" class="mb-4">
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <ul class="deliv flex">
                                                @foreach (json_decode($item->deliverables, true) as $deliverable)
