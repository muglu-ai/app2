                    ...
                    <div class="row mb-4 align-items-center">
                        <div class="col-md-6">
                            ...
                            <p class="text-muted mt-2">
                                Showcase your brand at {{config('constants.EVENT_NAME')}} {{config('constants.EVENT_YEAR')}}
                            </p>
                        </div>
                            ...
                            <div class="d-flex align-items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <p class="text-muted">
                                        ...
                                        website <a href="{{config('constants.EVENT_WEBSITE')}} {{config('constants.EVENT_YEAR')}}" target="_blank">{{config('constants.EVENT_NAME')}} {{config('constants.EVENT_YEAR')}}</a>
