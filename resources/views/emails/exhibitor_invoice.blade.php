                                        ...
                                        <table border="0" cellspacing="0" cellpadding="0">
                                            <tr>
                                                <td align="center" style="border-radius: 5px; background-color: #007bff;">
                                                    <a href="[Link to Payment Portal]" target="_blank" style="font-size: 16px; font-family: Arial, sans-serif; color: #ffffff; text-decoration: none; border-radius: 5px; padding: 12px 25px; border: 1px solid #007bff; display: inline-block; font-weight: bold;">
...
{{--                            <p style="margin-top: 20px; font-family: Arial, sans-serif; font-size: 14px; color: #555555;">--}}
{{--                                Upon successful payment, a final tax invoice and booking confirmation will be sent to you.--}}
{{--                            </p>--}}
                        </td>
                    </tr>
