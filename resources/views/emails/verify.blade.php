...
<div style="max-width: 600px; margin: 40px auto; background: #ffffff; padding: 30px; border-radius: 8px; box-shadow: 0 4px 10px rgba(0, 0, 0, 0.1);">
    ...
    <div style="font-size: 16px; color: #333; line-height: 1.6; text-align: center;">
        <p>Dear {{ $user->name }},</p>
        <p>Thank you for registering for <strong>{{config('constants.EVENT_NAME')}} {{config('constants.EVENT_YEAR')}}</strong>. To complete your registration, please verify your email address by clicking the button below.</p>
