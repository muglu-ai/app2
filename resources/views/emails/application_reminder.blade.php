...
<html>
<head>
    <title>Application Reminder - {{config('constants.APP_NAME')}}</title>
</head>
...
<table width="100%" cellpadding="0" cellspacing="0" border="0" style="background-color: #ffffff; max-width: 600px; margin: 20px auto; padding: 20px; border-radius: 5px; box-shadow: 0px 0px 10px #cccccc;">
    <tr>
        <td align="center" style="padding-bottom: 20px;">
            <!-- Logo Placeholder -->
            <img src="{{config('constants.event_logo')}}" alt="{{config('constants.APP_NAME')}}" style="max-width: 150px; margin-bottom: 20px;">
            <div class="logo-text" style="margin-top: 10px;">{{config('constants.APP_NAME')}}</div>
        </td>
    </tr>
    <tr>
        <td>
            ...
            <p style="line-height: 1.6; font-weight: bold;">{{config('constants.APP_NAME')}} Team</p>
        </td>
    </tr>
</table>
</body>
