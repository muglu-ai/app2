...
<tr>
    <td align="center" style="padding: 10px 0; background-color: #ffffff; border-bottom: 1px solid #eeeeee;">
        <img src="{{config('constants.event_logo')}}" alt="Logo" style="max-width: 180px;">
...
<tr>
    <td style="padding: 20px; text-align: center; color: #666666; font-size: 14px; border-top: 1px solid #eeeeee;">
        <p style="margin: 0 0 10px 0;">If you have any questions, please contact us at <a href="mailto:{{config('constants.admin_email.to.0')}}">{{config('constants.admin_email.to.0')}}</a> .</p>
        <p style="margin: 0;">Thank you for sponsor registration at {{config('constants.EVENT_NAME')}} {{config('constants.EVENT_YEAR')}}.</p>
    </td>
</tr>
