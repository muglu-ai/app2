...
<tr>
    <td style="padding: 20px; text-align: center; color: #666666; font-size: 14px; border-top: 1px solid #eeeeee;">
        <p style="margin: 0 0 10px 0;">
            ...
            <a href="mailto:{{ config('constants.admin_emails.to.0') }}">{{ config('constants.admin_emails.to.0') }}</a>.
        </p>
        <p style="margin: 0;">Thank you for exhibitor registration at {{config('constants.EVENT_NAME')}} {{config('constants.EVENT_YEAR')}}.</p>
    </td>
</tr>
