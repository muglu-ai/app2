    ...
    <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="max-width: 600px; margin: 0 auto; background-color: #ffffff; border-collapse: collapse;">
        ...
        <tr>
            <td style="padding: 20px; text-align: center; background-color: #ffffff;">
                <img src="{{config('constants.event_logo')}}" alt="{{config('constants.APP_NAME')}} Logo" style="max-width: 150px;">
                <h2 style="margin: 10px 0 0 0; font-size: 20px; color: #333333;">{{config('constants.APP_NAME')}}</h2>
            </td>
        </tr>
        ...
        <tr>
            <td style="padding: 20px 30px 30px 30px;">
                ...
                <p style="margin: 0; text-align: center;">
                    <a href="{{config('constants.APP_URL')}}/login" style="display: inline-block; padding: 12px 24px; background-color: #0056b3; color: #ffffff; text-decoration: none; font-weight: bold; border-radius: 4px;">Log in to Exhibitor Portal</a>
                </p>
            </td>
        </tr>
        ...
        <tr>
            <td style="padding: 20px 30px; text-align: center; background-color: #f8f8f8; font-size: 14px; color: #666666; border-top: 1px solid #dddddd;">
                <p style="margin: 0 0 10px 0;">If you have any questions, please email to <a href="mailto:{{config('constants.MAIL_FROM_ADDRESS')}}">{{config('constants.MAIL_FROM_ADDRESS')}}</a>. </p>
            </td>
        </tr>
    </table>
</body>
