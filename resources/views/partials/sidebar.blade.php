<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-radius-lg fixed-start ms-2  bg-white my-2" style="background: #FFFFFF;"
    ...
    <div class="sidenav-header">
        ...
        <a class="navbar-brand px-4 py-3 m-0" href="#">
            ...
            <br>
            <span class="ms-1 text-lg text-dark">{{config('constants.EVENT_NAME')}} {{config('constants.EVENT_YEAR')}}</span>
        </a>
    </div>
            ...
            <li class="nav-item">
                <a href="/sales" class="nav-link text-dark "
                   aria-controls="pagesExamples" role="button" aria-expanded="false">
                    {{--                    <i class="material-symbols-rounded opacity-5 {% if page.brand == 'RTL' %}ms-2{% else %} me-2{% endif %}">fa-user</i>--}}
                    <i class="fa-solid fa-chart-line"></i>
