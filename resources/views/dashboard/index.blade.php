            ...
            <div class="col-xl-3 col-sm-6 mb-4">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <div>
                            <p class="text-sm mb-0 text-capitalize">Total Stall Manning /Exhibitor Delegate Allocated</p>
                            <h3 class="mb-0">{{ $exhibitionParticipant['stall_manning_count'] ?? 0 }}</h3>
                        </div>
                    ...
                    <div class="card-footer">
                        <p class="mb-0 text-sm"><a href="exhibitor/list/stall_manning" class="text-success font-weight-bolder">Click here</a> for more info.</p>
                    </div>
                </div>
            </div>
            <div class="col-xl-3 col-sm-6 mb-4">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <div>
                            <p class="text-sm mb-0 text-capitalize">Total Complimentary Delegate Allocated</p>
                            <h4 class="mb-0">{{ $exhibitionParticipant['complimentary_delegate_count'] ?? 0 }}</h4>
                        </div>
                        <div class="icon icon-md icon-shape bg-gradient-dark text-center border-radius-lg">
                            <i class="material-symbols-rounded opacity-10">weekend</i>
                        </div>
                    ...
                    <div class="card-footer">
                        <p class="mb-0 text-sm"><a href="exhibitor/list/complimentary" class="text-success font-weight-bolder">Click here</a> for more info.</p>
                    </div>
                </div>
            </div>
        </div>
