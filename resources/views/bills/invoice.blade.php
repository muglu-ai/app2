...
<head>
    ...
    <title>{{config('constants.EVENT_NAME')}} {{config('constants.EVENT_YEAR')}}- Invoice</title>
        ...
        <td align="center">
            ...
            <tr>
                    <td align="center" style="padding-bottom: 20px;">
                        <img src="{{ asset('assets/images/logo.svg') }}" style="width: 100px; height: auto;" alt="{{config('constants.EVENT_NAME')}}">
                    </td>
                </tr>
                <tr>
                    <td align="center">
