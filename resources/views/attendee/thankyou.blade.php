  ...
  <div class="container text-center mt-5">
    <div class="container">
      <div class="row">
        ...
        <img src="{{config('constants.event_logo')}}" class="img-fluid">
        </div>
    ...
    <h1 class="mb-4">Thank You, {{ ucfirst($attendee->first_name) }}!</h1>

    <p>Your registration is successful. Below is your unique registration ID:</p>
    <h4 class="text-primary">{{ $attendee->unique_id }}</h4>

    <p> A confirmation email has been sent to your registered email address. For more event details, please visit our website.
    </p>
    <div class="my-4">
      <img src="{{ $qrCode }}" alt="QR Code">
    </div>

    <a href="{{config('constants.EVENT_WEBSITE')}}" class="btn btn-success"> {{config('constants.APP_NAME')  }} </a>
  </div>
</body>
</html>
