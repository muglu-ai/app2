  ...
  <div class="card mb-4">
    <div class="card-body">
      ...
      <div class="row g-3">
        ...
        <!-- Job Function -->
        <div class="col-md-12">
          <label>Your primary job function: <span class="important">*</span></label>
          <select class="form-select" name="attendees[${index}][job_function]" required>
            ${renderSelectOptions(jobFunctions, [oldData.job_function])}
          </select>
        </div>
