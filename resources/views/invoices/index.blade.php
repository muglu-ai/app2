                ...
                <div class="card">
                    ...
                    <div class="card-body">
                                            ...
                                            @foreach ($application->invoices as $invoice)
                                                <tr class="text-start">
                                                    <td class="text-dark text-md">
                                                        <div class="mb-0 text-md text-dark text-start"
                        ...
                        @else badge-danger @endif">
                                                    ...
                                                    <td class="text-dark text-md">
                                                        <a href="{{ route('invoice.show', ['id' => $invoice->invoice_no]) }}"
                        ...
                        <div class="modal-body">
                            <form id="uploadReceiptForm" action="{{ route('upload.receipt') }}" method="POST"
                                ...
                                <div class="mb-3 input-group input-group-dynamic">
                                    ...
                                    <input type="text" class="multisteps-form__input form-control" id="app_id"
                                        name="app_id" value="" readonly required>
                                </div>
                                <div class="mb-3 input-group input-group-dynamic">
                    ...
                    fetch('{{ route('upload.receipt') }}', {
                        ...
                        .then(data => {
                            if (data.message) {
                                ...
                                Swal.fire({
                                    ...
                                    var uploadReceiptModal = bootstrap.Modal.getInstance(document
                                ...
                                Swal.fire({
                                    icon: 'error',
                                    title: 'Upload Failed',
                                    text: data.error ? Object.values(data.error) :
                        ...
                        .catch(error => {
                            Swal.fire({
                                ...
                                text: 'Error: ' + data.error ? Object.values(data.error) :
                                    'Something went wrong, please try again.'
                            });
                        });
